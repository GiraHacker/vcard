            ...
            <div className="col-xs-12 col-sm-12">
              <div className="testimonials owl-carousel">
                ...
                <div className="testimonial">
                  ...
                  <div className="text">
                    <p>
                      Vivamus at molestie dui, eu ornare orci. Curabitur vel
                      egestas dolor. Nulla condimentum nunc sit amet urna
                      tempus finibus. Duis mollis leo id ligula pellentesque,
                      at vehicula dui ultrices.
                    </p>
                  </div>
